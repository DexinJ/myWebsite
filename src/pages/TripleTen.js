...
const TripleTen = () => {
  useEffect(() => {
    document.title = "Tony Jin: TripleTen";
  }, []);
  return (
    <div className="Page">
      <Subheader />
      <div className="Page-body">
        ...
        <div className="twintexttwo bmarg">
          <div>
            ...
            {/* For this projects, I joined tripleten for projects that will improve */}
            <div>
              ...
              <p>
                After discussion, we decided to make a platformer, and I would
                be the level designer and programmer.
              </p>
            </div>
          </div>
          <div className="caption">
            ...
            <p className="twincaption">
              The tile sheet. It is converted into a tile map and is the basis
              for this game's platforms.
            </p>
          </div>
        </div>
        <div className="bmarg">
          ...
          <p>
            After completing the game, we conducted playtest sessions where
            other classmates play-tested our game and gave feedback and
            suggestions, after which we adjusted our game accordingly.
          </p>
        </div>
