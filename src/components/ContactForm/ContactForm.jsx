...
const ContactForm = () => {
  ...
  const accessKey = "430224f3-49cc-4754-932b-4743a6b539bc";
  ...
  return (
    <section className={styles.contactForm} aria-label="Contact form">
      <div className={styles.form}>
        ...
        <div className={styles.message} role="alert" aria-live="polite">
          {result &&
            (isSuccess ? (
              <img
                src="/images/icons/check-mark-button-svgrepo-com.svg"
                alt=""
                className={styles.iconImage}
              />
            ) : (
              <img
                src="/images/icons/gui-check-no-svgrepo-com.svg"
                alt=""
                className={styles.iconImage}
              />
            ))}
